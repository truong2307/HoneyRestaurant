...
using Honey.Services.Identity.MainModule.Account;
...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            {
                var resultSignIn = await _signInManager.PasswordSignInAsync(model.Username, model.Password, model.RememberLogin, lockoutOnFailure:false);
                if (resultSignIn.Succeeded)
                {
                    var userInDb = await _userManager.FindByNameAsync(model.Username);
                    await _events.RaiseAsync(new UserLoginSuccessEvent(userInDb.UserName, userInDb.Id, userInDb.UserName,
